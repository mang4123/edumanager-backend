...
const QuestionsSection = () => {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      // Buscar dúvidas usando a nova rota da API
      const response = await fetch('/api/aluno/duvidas', {
        headers: {
  ...
  const handleQuestionSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Enviar dúvida usando a nova rota da API
      const response = await fetch('/api/aluno/duvidas', {
        method: 'POST',
        headers: {
